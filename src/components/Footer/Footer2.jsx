...
const Footer2 = () => {
    return (
        <footer className="bottom-0 left-0 z-20 w-full p-4 bg-[#5589aa] text-white border-t border-gray-200 shadow text-center md:flex md:items-center md:justify-between md:px-10 mb-16 md:mb-0">
            <span className="text-sm sm:text-center dark:text-white">© 2023 <a href="https://flowbite.com/" className="hover:underline">ICT DEV</a> -  PT. Industri Nabati Lestari.
            </span>
            <ul className="flex items-center justify-center mt-3 text-sm md:mt-0 space-x-5">
                <li>
                    <span className='text-xs italic text-white md:text-white'>Subdiary :</span>
                </li>
                <li>
                    <img src="img/n3-white.png" alt="PTPN 3" className='sm:h-9 sm:w-15 w-[100px] h-[30px]' />
                    {/* <a href="#" className="mr-4 hover:underline md:mr-6 "><FaInstagram/></a> */}
                </li>
                <li>
                    <img src="img/n4-white.png" alt="PTPN 3" className='sm:h-12 sm:w-15 w-[60px] h-[60px]' />
                    {/* <a href="#" className="mr-4 hover:underline md:mr-6"><FaFacebookSquare/></a> */}
                </li>
            </ul>
        </footer>
        // <footer className="bg-white bottom-0 dark:bg-gray-900">
        //     <div className="px-4 py-8 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
